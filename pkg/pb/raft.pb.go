...
const (
	...
	ClusterCommand_DICTIONARY_SCAN          ClusterCommand_Type = 12
...
func (x *ClusterCommand) GetId() *Id {
	if x, ok := x.GetPayload().(*ClusterCommand_Id); ok {
		return x.Id
	}
	return nil
}

func (x *ClusterCommand) GetCid() *ClientId {
	if x, ok := x.GetPayload().(*ClusterCommand_Cid); ok {
		return x.Cid
	}
	return nil
}
...
type ClusterCommand_Id struct {
	Id *Id `protobuf:"bytes,10,opt,name=id,proto3,oneof"`
}

type ClusterCommand_Cid struct {
	Cid *ClientId `protobuf:"bytes,11,opt,name=cid,proto3,oneof"`
}
...
func (*ClusterCommand_Id) isClusterCommand_Payload() {}

func (*ClusterCommand_Cid) isClusterCommand_Payload() {}
...
var file_raft_proto_rawDesc = []byte{
	...
	0x06, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0xa3, 0x07, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73,
	...
	,
...
var file_raft_proto_goTypes = []interface{}{
	...
	(*Id)(nil),               // 7: github.com.vontikov.stoa.v1.Id
	(*ClientId)(nil),         // 8: github.com.vontikov.stoa.v1.ClientId
}
var file_raft_proto_depIdxs = []int32{
	...
	7, // 5: github.com.vontikov.stoa.v1.ClusterCommand.id:type_name -> github.com.vontikov.stoa.v1.Id
	8, // 6: github.com.vontikov.stoa.v1.ClusterCommand.cid:type_name -> github.com.vontikov.stoa.v1.ClientId
...
func file_raft_proto_init() {
	...
	file_raft_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*ClusterCommand_Id)(nil),
		(*ClusterCommand_Cid)(nil),
	}
	type x struct{}
